    ...
    <div>
      ...
      <Row gutter={16} style={{ marginBottom: 24 }}>
        ...
        <Col xs={12} sm={6}>
          <Card style={{ background: theme.cardBg, border: `1px solid ${theme.borderColor}`, borderRadius: 16 }}>
            <div style={{ textAlign: 'center' }}>
              <ClockCircleOutlined style={{ fontSize: 32, color: '#0071e3' }} />
              <div style={{ fontSize: 28, fontWeight: 'bold', color: '#0071e3', marginTop: 8 }}>{content.inProgressTasks}</div>
                      ...
                      <li key={taskIndex} style={{ marginBottom: 6, lineHeight: 1.5 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                          {task.status === 'COMPLETED' ? (
                            ...
                            <ClockCircleOutlined style={{ color: '#0071e3', fontSize: 12 }} />
                          ) : (
                        ...
                        <div style={{ display: 'flex', gap: 4, marginTop: 2, marginLeft: 18 }}>
                          ...
                          {task.progress && (
                            <span style={{ fontSize: 10, color: '#0071e3' }}>{task.progress}</span>
                          )}
                        </div>
                      </li>
                    ))}
